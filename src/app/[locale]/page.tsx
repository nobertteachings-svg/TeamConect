            ...
            <div className="grid gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)] lg:items-center lg:gap-12">
              ...
              <div className="relative mx-auto w-full max-w-md lg:max-w-none lg:pt-2">
                ...
                <div className="relative">
                  ...
                  <div className="rounded-2xl border border-white/20 bg-slate-950/50 p-5 shadow-2xl shadow-black/35 ring-1 ring-white/10 backdrop-blur-sm sm:p-6">
                    <p className="text-sm leading-relaxed text-sky-100/95 sm:text-[15px]">{t("heroMainScreenshotAlt")}</p>
                    <p className="mt-4 border-t border-white/10 pt-4 text-sm leading-relaxed text-sky-200/90 sm:text-[15px]">
                      {t("heroInsetScreenshotAlt")}
                    </p>
                    ...
                    <p className="mt-4 border-t border-white/10 pt-4 text-xs leading-relaxed text-sky-300/85">{t("heroPreviewMeta")}</p>
                  </div>
                </div>
              </div>
            </div>
